  ...
  const handleSubmit = async () => {
    ...
    if (item.itemType === "PERFORMANCE") {
      await updatePerformanceMutation.mutateAsync({
        ...
        currentThumbnailImageId: item?.thumbnailImageId ? String(item.thumbnailImageId) : undefined,
        currentThumbnailMediaId: item?.thumbnailMediaId ? String(item.thumbnailMediaId) : undefined,
